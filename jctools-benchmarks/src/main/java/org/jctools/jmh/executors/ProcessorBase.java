...
public abstract class ProcessorBase<T> extends HandlerBase {
   ...
   private static final Logger logger = Logger.getLogger(org.apache.activemq.artemis.utils.actors.ProcessorBase.class);
   ...
   public int shutdownNow(Consumer<? super T> onPendingItem) {
      ...
      if (inHandler()) {
         ...
         do {
            ...
            final int startState = this.state;
   ...
   public ProcessorBase(Queue<T> tasks, Executor parent) {
      this.tasks = tasks;
