...
public class OrderedExecutor extends ProcessorBase<Runnable> implements ArtemisExecutor
{
   ...
   public OrderedExecutor(Queue<Runnable> tasks, Executor delegate) {
      super(tasks, delegate);
   }

   private static final Logger logger = Logger.getLogger(org.apache.activemq.artemis.utils.actors.OrderedExecutor.class);
